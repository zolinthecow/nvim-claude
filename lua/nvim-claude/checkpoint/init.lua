...
function M.create_checkpoint(prompt_text) return core.create_checkpoint(prompt_text) end
function M.list_checkpoints() return core.list_checkpoints() end

-- State helpers (minimal)
function M.is_preview_mode() return core.is_preview_mode() end
...
function M.exit_preview_mode() return core.exit_preview_mode() end
function M.accept_checkpoint() return core.accept_checkpoint() end
