...
local function hooks_block(paths)
  ...
  table.insert(t, '')
  -- Write tool rules (apply_patch, write_stdin)
  table.insert(t, '[[hooks.pre_tool_use_rules]]')
  table.insert(t, string.format('argv = ["%s"]', paths.pre))
  table.insert(t, 'include = ["apply_patch", "write_stdin"]')
  table.insert(t, 'exclude = []')
  table.insert(t, '')
  table.insert(t, '[[hooks.post_tool_use_rules]]')
  table.insert(t, string.format('argv = ["%s"]', paths.post))
  table.insert(t, 'include = ["apply_patch", "write_stdin"]')
  table.insert(t, 'exclude = []')
  table.insert(t, '')
  -- Shell rm rules
