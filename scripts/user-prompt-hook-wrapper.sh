...
TARGET_FILE="$TARGET_FILE" "$SCRIPT_DIR/nvim-rpc.sh" --remote-expr "luaeval(\"require('nvim-claude.hooks').user_prompt_submit_hook_b64('$PROMPT_B64')\")" 2>&1 | tee -a "$LOG_FILE"
